            ...
            case R.id.action_Save:
                if (Validated_Form()) {
                    ...
                    if (shipper == null) {
                        ...
                        Shipper temp = new Shipper(shipper.getiDShipper(), "", edtTk.getText().toString(), edtMk.getText().toString(), edtTen.getText().toString(), edtDiaChi.getText().toString(), "", edtNgaysinh.getText().toString(), edtMaxe.getText().toString(), edtSdt.getText().toString(), TrangThaiShipper.KhongHoatDong, "Hệ thống");
        ...
        if (!validate.isBlank(edtTk) && validate.isEmail(edtTk)
            ...
            if (cmndTrc == null || cmndSau == null) {
                Alerter.create(getActivity())
                        .setText("Vui lòng tải lên 2 mặt CMND/CCCD")
                        .setTitle("Thông báo")
            ...
            if (avaTar == null) {
                Alerter.create(getActivity())
                        .setText("Vui lòng tải ảnh cá nhân")
                        .setTitle("Thông báo")
                        .setIcon(R.drawable.ic_error)
                        .setDuration(3000)
                        .show();
